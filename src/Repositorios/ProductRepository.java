...
public class ProductRepository {
    ...
    public static List<Produto> find(Predicate<Produto> p) {
        ...
        _p.add(new Maquiagem("CORRETIVO LÍQUIDO", "RARE BEAUTY", "LIQUID TOUCH", 5, 159.90, "Um corretivo leve e hidratante com cobertura média a total, de longa duração, que não craquela e ilumina a pele."));
        _p.add(new Maquiagem("MÁSCARA DE CÍLIOS", "KYLIE COSMETICS", "KYLASH", 5, 159.90, "Se você está em busca do segredo para cílios volumosos, alongados e cheios de personalidade, então a Máscara de Cílios Kylie Cosmetics Kylash, será sua aliada definitiva para um olhar irresistível e marcante."));
        _p.add(new Maquiagem("CORRETIVO LIQUIDO", "DIOR", "FOREVER SKIN CONCEALER", 5, 159.90, "Em uma única passada, este corretivo multiuso de alta cobertura com textura cremosa, esconde olheiras, vermelhidão localizada, manchas e imperfeições para uma correção impecável e disfarce de olheiras, sem transferência. De manhã à noite, alisa e realça a pele, sem marcar as linhas do rosto. Ele resiste em todas as condições de calor e umidade."));
